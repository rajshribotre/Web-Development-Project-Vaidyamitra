        ...
        <div className="flex justify-between gap-[50] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className='w-full lg:w-1/2 xl:w-[670px] order-2'>
            ...
            <p className='text__para'>
              For 30 years in a row, U.S. News and world Report has recognizes us as one of the best publics hospitals in th Nation and #1 in texas. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quas, nemo?
            </p>
